...
func (c *p2PClient) Request(ctx context.Context, in *RequestAccess, opts ...grpc.CallOption) (*ReplyToRequest, error) {
	out := new(ReplyToRequest)
...
func _P2P_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(P2PServer).Request(ctx, req.(*RequestAccess))
	}
